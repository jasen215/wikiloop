...
### 清理英文 synthesized pages 后（2026-06-23，稳定基准）

| 版本 | AR | CP | CR | Hit Rate | MRR |
|---|---|---|---|---|---|
| **有向量（清理后，当前最佳）** | **0.992** | **0.591** | **0.614** | **0.667** | **0.472** |
| **无向量（清理后）** | 1.000 | 0.375 | 0.308 | 0.167 | 0.044 |

**向量搜索贡献（清理后稳定版）：**
- CR：0.614 vs 0.308，**+0.306（+99%）**
- CP：0.591 vs 0.375，**+0.216（+58%）**
- Hit Rate：0.667 vs 0.167，**+0.500（+300%）**
